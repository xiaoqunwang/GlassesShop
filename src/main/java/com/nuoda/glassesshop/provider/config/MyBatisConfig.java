package com.nuoda.glassesshop.provider.config;

import com.nuoda.glassesshop.common.utils.DynamicDataSource;
...
@Configuration
@MapperScan(basePackages = "com.nuoda.glassesshop.dao")

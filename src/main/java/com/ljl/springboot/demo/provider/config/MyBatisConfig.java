package com.ljl.springboot.demo.provider.config;

import com.ljl.springboot.demo.common.DynamicDataSource;
...
@Configuration
@MapperScan(basePackages = "com.ljl.springboot.demo.provider.config.dao")
